...
| Cursor working copy | `src/tools/gmtitle/cursor_swcad_title_scale_ux.lsp` | Short commands: `SWSTAT`, `SWGO`, `SWCHECK`, `SWPREP`, `SWNEXT`, `SWMORE` | `src/tools/gmtitle/cursor_swcad_title_scale_ux_load.lsp` |
