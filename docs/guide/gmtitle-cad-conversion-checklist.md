...
이 상태에서는 `SWTITLECONVERT`로 첫 native GMTITLE 기준 객체를 만듭니다.
...
A4 원본 2장은 표제란 없는 도면틀-only 시트일 수 있습니다. 이 경우 A4에 `DR_titlea_3rd`가 생기면 성공이 아니라 잘못된 추가일 수 있습니다.
...
표제란 없는 A4 -> DR_A4_Outline 도면틀만 있음, 더블클릭할 제목블록 없음
