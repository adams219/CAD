...
GMTITLE LSP 버전: 260705-convertnext-selection-guide
...
gmtitle: 260705-convertnext-selection-guide
...
신뢰 가능:
  ...
  SWTITLE LSP 버전이 260705-convertnext-selection-guide
  방금 실행한 명령 결과임
...
| --- | --- | --- | --- |
| 버전/도면 고정 | 지금 열린 CAD가 최신 LSP와 work 복사본을 보고 있는가 | `SWTITLEVERSION=260705-convertnext-selection-guide`, `작업 폴더 복사본: 예` | `SWTITLECONVERTNEXT` 실행 |
...
```text
SWTITLEVERSION:
260705-convertnext-selection-guide
...
2. SWTITLEVERSION으로 gmtitle 버전이 260705-convertnext-selection-guide인지 확인
