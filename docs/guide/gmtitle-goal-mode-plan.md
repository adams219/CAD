...
GMTITLE LSP 버전: 260706-unified-title-missing-11
...
gmtitle: 260706-unified-title-missing-11
...
신뢰 가능:
  ...
  SWTITLE LSP 버전이 260706-unified-title-missing-11
  방금 실행한 명령 결과임
...
| --- | --- | --- | --- |
| 버전/도면 고정 | 지금 열린 CAD가 최신 LSP와 work 복사본을 보고 있는가 | `SWTITLEVERSION=260706-unified-title-missing-11`, `작업 폴더 복사본: 예` | `SWTITLECONVERTNEXT` 실행 |
...
2. SWTITLEVERSION으로 gmtitle 버전이 260706-unified-title-missing-11인지 확인
