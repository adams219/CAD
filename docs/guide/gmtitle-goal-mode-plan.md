...
gmtitle: 260705-verify-source-priority-a4stepnote
...
신뢰 가능:
  ...
  SWTITLE LSP 버전이 260705-verify-source-priority-a4stepnote
  방금 실행한 명령 결과임
...
| --- | --- | --- | --- |
| 버전/도면 고정 | 지금 열린 CAD가 최신 LSP와 work 복사본을 보고 있는가 | `SWTITLEVERSION=260705-verify-source-priority-a4stepnote`, `작업 폴더 복사본: 예` | `SWTITLECONVERT` 실행 |
...
2. SWTITLEVERSION으로 gmtitle 버전이 260705-verify-source-priority-a4stepnote인지 확인
