...
if ($Modes -contains "DOWNSTREAM") {
  ...
  -Required @(
    ...
    "Resource cleanup definition signature:",
    "Resource cleanup audit: yes",
    "Workflow state definition record: DICT|NOD/SWCAD_WORKFLOW_STATE|XRECORD|<WORKFLOW-STATE-XRECORD>",
    "Definition <NO-KEY> count: 0",
