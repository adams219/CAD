...
function New-FakeRepoWorkCopy {
  ...
  Set-Content -LiteralPath (Join-Path $gmtitlePath "swcad_title_scale.lsp") -Encoding ASCII -Value '(setq *swcad-title-scale-version* "260713-frame-style-structure-guard-1")'
...
function Write-FakeLog {
  param(
    ...
    [string]$LoadedVersion = "260713-frame-style-structure-guard-1",
    [string]$ExpectedVersion = "260713-frame-style-structure-guard-1",
