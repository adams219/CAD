...
function New-FakeRepoWorkCopy {
  ...
  Set-Content -LiteralPath (Join-Path $gmtitlePath "swcad_title_scale.lsp") -Encoding ASCII -Value '(setq *swcad-title-scale-version* "260706-unified-title-missing-10")'
...
function Write-FakeLog {
  param(
    ...
    [string]$LoadedVersion = "260706-unified-title-missing-10",
    [string]$ExpectedVersion = "260706-unified-title-missing-10",
