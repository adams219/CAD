...
function New-FakeRepoWorkCopy {
  ...
  Set-Content -LiteralPath (Join-Path $gmtitlePath "swcad_title_scale.lsp") -Encoding ASCII -Value '(setq *swcad-title-scale-version* "260707-unified-title-missing-12")'
...
function Write-FakeLog {
  param(
    ...
    [string]$LoadedVersion = "260707-unified-title-missing-12",
    [string]$ExpectedVersion = "260707-unified-title-missing-12",
