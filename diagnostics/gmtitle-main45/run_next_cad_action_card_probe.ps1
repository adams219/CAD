...
function New-FakeRepoWorkCopy {
  ...
  Set-Content -LiteralPath (Join-Path $gmtitlePath "swcad_title_scale.lsp") -Encoding ASCII -Value '(setq *swcad-title-scale-version* "260710-native-title-missing-frame-1")'
...
function Write-FakeLog {
  param(
    ...
    [string]$LoadedVersion = "260710-native-title-missing-frame-1",
    [string]$ExpectedVersion = "260710-native-title-missing-frame-1",
