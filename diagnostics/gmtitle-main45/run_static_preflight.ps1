...
Assert-Contains -Text $suiteText -Needle "Before target title count: 2" -Label "Suite title-missing preserves existing title count before convert"
Assert-Contains -Text $suiteText -Needle "After target title count: 2" -Label "Suite title-missing does not add title after convert"
