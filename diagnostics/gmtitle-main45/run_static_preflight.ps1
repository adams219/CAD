...
Assert-Contains -Text $openWorkcopyRunnerText -Needle "By default it does not use /b startup scripts" -Label "Open workcopy helper no-startup-script default"
Assert-Contains -Text $openWorkcopyRunnerText -Needle "GSTARCAD_NO_VISIBLE_WINDOW" -Label "Open workcopy helper no-window guard"
Assert-Contains -Text $openWorkcopyRunnerText -Needle "Stable visible GstarCAD window handle" -Label "Open workcopy helper stable-window guard"
...
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "Initial next-action card" -Label "Manual session wrapper initial next-action card"
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "Initial next-action short summary:" -Label "Manual session wrapper initial short summary"
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "GMTITLE paper/frame to choose:" -Label "Manual session wrapper paper/frame summary"
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "Required options: Frame positioning ON, Object move OFF" -Label "Manual session wrapper required options summary"
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "CAD command order:" -Label "Manual session wrapper CAD command order summary"
...
Assert-Contains -Text $manualGmtitleSessionRunnerText -Needle "output suppressed by -Compact" -Label "Manual session wrapper compact suppression message"
