...
Assert-LogContains `
  ...
  -Patterns @(
    ...
    "source-title-count: 11",
    "source-frame-count: 13",
    "frame-only-count: 2",
    "target-title-count: 2",
    "target-frame-count: 2",
    "A2: 1",
    "A3: 12",
    "A3: 1",
    "A4: 2",
...
Assert-LogContains `
  ...
  -Patterns @(
    ...
    "target-title-count: 2",
    "target-frame-count: 2",
    "target-gmtitle-pair-count: 2",
    "native-like-target-pair-count: 2",
...
Assert-LogContains `
  ...
  -Patterns @(
    "Load result: OK",
    "Loaded version: 260707-convert-next-clone-upgrade-19",
    "Before source-title-count: 11",
    "Before frame-only-count: 2",
    "Before target title count: 2",
    ...
    "After source-title-count: 11",
    "After frame-only-count: 1",
    "After target title count: 2",
...
Assert-LogContains `
  ...
  -Patterns @(
    ...
    "Source titles before/after: 11/11",
    "Source frames before/after: 13/13",
    "Frame-only before/after: 2/2",
    "Target titles before/after: 2/2",
    "Target frames before/after: 2/2",
