...
Assert-LogContains `
  ...
  -Patterns @(
    ...
    "Command c:SWTITLEVERIFY: yes",
    "Command c:SWTITLEFASTSTATUS: no",
    "Result: OK SWTITLESTATUS status=NEXT_UPGRADE_NATIVE_GMTITLE",
...
Assert-LogContains `
  ...
  -Patterns @(
    ...
    "non-native-like-target-pair-count: 2",
    "cloned-gmtitle-pair-count: 1",
    "a2a3a4-native-upgrade-candidate-count: 2",
